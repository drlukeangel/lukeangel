...
date: 2014-02-18T04:28:37.000Z
category: tools
tags:
  - home-automation
  - iot
excerpt: Last night when my friend showed up to my house I answered the doorbell through my phone while still down the street picking up dinner. I told her I would be there in a few minutes, and…
wpCategory: iot
wpUrl: /iot/the-internet-of-things-version-0-5/
cover: ../../assets/blog/iot-version-0-5-cover.png
coverAlt: 'Cover graphic for "The Internet of Things, version 0.5" — the half-finished current state of connected devices and protocols'
---
...
![IoT v0.5 — current state of connected devices: thermostats, fitness trackers, and smart-home gadgets each siloed in their own apps](../../assets/blog/iot-version-0-5-current-state-connected-devices.jpg)
...
![IoT future-mesh diagram — interconnected devices sharing data via open standards rather than vendor-walled apps](../../assets/blog/iot-version-0-5-future-mesh-interconnected-devices.jpg)
...
![IoT architecture diagram — sensors at the edge, gateway aggregating data, and cloud platform for analytics and rules](../../assets/blog/iot-version-0-5-architecture-cloud-edge-diagram.png)
