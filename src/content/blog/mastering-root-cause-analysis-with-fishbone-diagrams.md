---
title: Mastering Root Cause Analysis with Fishbone Diagrams
...
![5-Whys companion diagram — symptom at the top (site outage), then five Why? boxes each drilling one level deeper (deploy crash → missing env var → not set after secret rotation → playbook doesn't propagate), landing on an actionable root cause at the bottom (missing automation step in the secret-rotation runbook)](../../assets/blog/fishbone-5-whys-progressive-2025.svg)
...
![Fishbone (Ishikawa) diagram for increased patient complaints about scheduling appointments — causes grouped under Staffing, Communication, Technology, and Procedures](../../assets/blog/fishbone-diagram-patient-complaints-staffing-communication-procedures.png)
