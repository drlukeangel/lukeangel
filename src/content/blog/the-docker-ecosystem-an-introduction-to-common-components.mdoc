---
title: 'Docker: An Introduction to Common Components'
date: 2016-01-13T21:39:59.000Z
category: tools
tags:
  - components
  - docker
...
![Docker host architecture diagram — Docker Engine running multiple isolated containers on a single Linux host](../../assets/blog/docker-ecosystem-host-engine-containers-diagram.png)
...
![Docker image and layer stack diagram — each Dockerfile instruction adds a read-only layer, container adds a writable layer on top](../../assets/blog/docker-ecosystem-images-layers-stack-diagram.png)
...
- [**zookeeper**](https://www.digitalocean.com/community/tutorials/an-introduction-to-mesosphere)~~: service discovery / globally distributed key-value store** 
...
![Docker registry / Hub deployment flow — build image locally, push to registry, pull on production hosts](../../assets/blog/docker-ecosystem-registry-hub-deployment-flow.png)
...
- [**marathon**](https://www.digitalocean.com/community/tutorials/an-introduction-to-mesosphere)~~: scheduler and service management tool.** 

- [**Swarm**](https://github.com/docker/swarm/)~~: scheduler and service management tool.** 

- [**mesos**](https://www.digitalocean.com/community/tutorials/an-introduction-to-mesosphere)~~: host abstraction service that consolidates host resources for the scheduler.** 
