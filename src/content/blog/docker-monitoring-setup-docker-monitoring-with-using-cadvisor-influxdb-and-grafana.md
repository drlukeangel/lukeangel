---
title: Docker Monitoring with cAdvisor, InfluxDB, and Grafana
date: 2016-11-13T16:06:06.000Z
category: tools
tags:
  - containers
  - docker
...
![InfluxDB login screen at port 8083 — used to verify the time-series database container is running and accessible](../../assets/blog/docker-monitoring-influxdb-login-screen.png)
...
![InfluxDB UI creating the cadvisor database — where cAdvisor will write Docker container metrics over time](../../assets/blog/docker-monitoring-influxdb-create-cadvisor-database.png)
...
![cAdvisor web UI at port 8080 — Google’s container monitoring tool showing realtime CPU, memory, and filesystem stats for the Docker host and its containers](../../assets/blog/docker-monitoring-cadvisor-host-stats-dashboard.png)
...
![Grafana Data Sources screen — adding the influxdb container as a data source with proxy access and the cadvisor database selected](../../assets/blog/docker-monitoring-grafana-influxdb-data-source-config.png)
...
![Grafana dashboard with the Add Panel → Graph option highlighted — first step in building a monitoring panel](../../assets/blog/docker-monitoring-grafana-add-graph-panel.png)

5) Click the Title area of the new Graph you created where it says “no title (click here)” and click *Edit***
![Grafana graph panel with the title area expanded for the Edit action — opens the query editor for the new panel](../../assets/blog/docker-monitoring-grafana-edit-graph-title.png)
...
![Grafana query editor with two queries against the stats series — mean(fs_limit) aliased as Limit and mean(fs_usage) aliased as Usage](../../assets/blog/docker-monitoring-grafana-fs-limit-usage-query.png)
...
![Complete Grafana Docker-monitoring dashboard — bandwidth, CPU usage per container, memory usage, and filesystem limit/usage panels](../../assets/blog/docker-monitoring-grafana-complete-dashboard-cpu-memory-bandwidth.png)
