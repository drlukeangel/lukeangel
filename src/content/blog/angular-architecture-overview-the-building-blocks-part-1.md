...
![Angular architecture overview diagram — Module, Component, Template, Directive, Metadata, Service, and Injector connected by property and event binding](../../assets/blog/angular-architecture-overview-diagram.png)
...
![Angular Module containing a Component — illustration of an NgModule declaring the components and services that belong to it](../../assets/blog/angular-modules-component-box.png)
...
![Angular libraries as collections of modules — Component, Service, Value, and Function pieces shown as small dashed module boxes](../../assets/blog/angular-libraries-module-pieces.png)
...
![Hero Component arrow rendering into a superhero illustration — showing how an Angular @Component class produces a rendered UI piece](../../assets/blog/angular-hero-component-superhero-rendering.png)
...
![Angular Template — HTML markup with Angular bindings that defines the component's view](../../assets/blog/angular-template-html-component-view.png)
...
![HeroListComponent template snippet — list of heroes rendered with *ngFor and Angular event handlers](../../assets/blog/angular-hero-list-component-template.png)
...
![HeroListComponent TypeScript class — properties, constructor, and methods that the template binds to](../../assets/blog/angular-hero-list-component-class.png)
...
![@Component decorator metadata for HeroListComponent — selector, templateUrl, providers connecting class to template](../../assets/blog/angular-hero-list-metadata-decorator.png)
...
![Angular data binding types — interpolation, property binding, event binding, and two-way binding shown side by side](../../assets/blog/angular-data-binding-types.png)
...
![Angular data binding syntax examples — {{ }} interpolation, [property], (event), and [(ngModel)] two-way binding notation](../../assets/blog/angular-data-binding-syntax-examples.png)

Data binding plays an important role in communication between a template and its component.

![Data binding flow between an Angular Component class and its Template — arrows showing both directions of property and event binding](../../assets/blog/angular-data-binding-component-template.png)

Data binding is also important for communication between parent and child components.

## ~~Directives**

![Angular Directives — structural directives like *ngFor and *ngIf that change DOM layout, plus attribute directives that change appearance](../../assets/blog/angular-directives-structural-attribute.png)
...
![Angular Service class — a TypeScript class with a narrow purpose like fetching data or logging, injected into components](../../assets/blog/angular-service-class-example.png)
...
![Angular Dependency Injection — Injector providing a Service instance to a Component constructor via its provider configuration](../../assets/blog/angular-dependency-injection-injector-service.png)
...
![Angular @Component providers array — telling the injector how to construct a service for a component's dependency tree](../../assets/blog/angular-providers-array-component-decorator.png)
