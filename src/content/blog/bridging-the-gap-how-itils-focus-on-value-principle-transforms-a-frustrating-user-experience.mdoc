---
title: How ITIL's “Focus on Value” transforms a frustrating UX
date: 2024-12-26T13:58:14.000Z
category: craft
tags:
  - business-value
  - focus-on-value
...
![ITIL Focus on Value diagram — the same incident handled two ways: top row shows 5 painful steps (submit ticket, mis-routed, scripted suggestion, escalation, closed without resolution); bottom row shows 4 streamlined steps (self-serve fix, on-call human, root-cause fix in same conversation, propagated to all users)](../../assets/blog/itil-focus-on-value-before-after-2024.svg)
...
![ITIL value mindset vs cost-center mindset — side-by-side comparison of the metric, the question asked, the conversation tone, the stakeholder relationship, and the budget outcome at year-end](../../assets/blog/itil-value-vs-cost-center-mindset-2024.svg)
