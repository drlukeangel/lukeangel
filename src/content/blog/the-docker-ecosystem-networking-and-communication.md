---
title: 'Docker: Networking and Communication'
date: 2016-04-13T21:37:30.000Z
category: tools
tags:
  - docker
  - networking
...
![Docker networking comparison — bridge driver on a single host with three containers on docker0, vs overlay driver connecting two hosts via a VXLAN tunnel](../../assets/blog/docker-ecosystem-networking-bridge-overlay-2016.svg)
...
![Port publishing diagram — client request on host port 80; iptables DNAT rule + docker-proxy forward through the docker0 bridge to container port 8080; container responds back through the same path. `docker run -p 80:8080` writes the rule.](../../assets/blog/docker-networking-port-publishing-2016.svg)
