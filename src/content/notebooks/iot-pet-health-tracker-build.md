---
title: "IoT Pet Health Tracker — Build"
summary: "Twelve years of paying other people's subscriptions to learn my pets are home. This is the build log for the tracker I actually want — cheap, no-subscription, months of battery, location first and health later — designed the way I'd run any connected-product program, then soldered together nights and weekends."
accent: "#1f7a6b"
---

The [Pet IoT Field Guide](/notebooks/pet-iot-field-guide/) is the observer's seat — twelve years of what shipped and what broke, kept in the order it happened. This notebook is the opposite chair: the builder's log.
